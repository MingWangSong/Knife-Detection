...
class PReNet(nn.Module):
	...
	#self.sa = SpatialAttention()
        ...
        #self.res_conv1 = DeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
        #      padding=1, groups=2, deformable_groups=2).cuda()
              
        #self.res_conv2 = DeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
        #      padding=1, groups=2, deformable_groups=2).cuda()
              
        self.res_conv3 = DeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
              
        self.res_conv4 = DeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
              
        self.res_conv5 = DeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
