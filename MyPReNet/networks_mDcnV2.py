...
class PReNet(nn.Module):
	...
	#self.sa = SpatialAttention()
        ...
        #self.self_attn = Self_Attn( 32, 'relu')
...
#            nn.ReLU()
#            )
        self.res_conv1 = ModulatedDeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
              
        self.res_conv2 = ModulatedDeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
              
        self.res_conv3 = ModulatedDeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
              
        self.res_conv4 = ModulatedDeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
              
        self.res_conv5 = ModulatedDeformConvPack(32, 32, kernel_size=(3, 3), stride=1,
              padding=1, groups=2, deformable_groups=2).cuda()
