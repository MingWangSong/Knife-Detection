...
def knife_detection(image_path):
    ...
    plt.imshow(img)
    # 绘制边缘
    plt.plot(edge, "-r", label='Gap region')
    # # 绘制峰值点
    # plt.scatter(peak_index, peak_num, c='g', marker='o', label='peak_num point')
    # 绘制包络线
    plt.plot(envelope_y, ":b", label='Upper envelope')
    # 绘制豁口边界线
...
def gap_detection(actual_edge, envelope_edge, gap_distance_threshold=10):
    """
        豁口检测
    Args:
...
# 图像处理函数，要传入路径
knife_detection(r'./images/source/571.jpg')
# r'./images/source/basedata/huo/new/1.png'
# r'./images/source/img1.png'
# r'./images/source/basedata/huo/new/5.jpg'